    ...
    <div className="container mb-5">
      ...
      <div className="row">
        <div className="col-md-4 col-sm-6">
          <img className="w-50 d-block mx-auto" src={require("../images/clock-icon.svg")} alt="" />
        ...
        <div className="col-md-4 col-sm-6">
          <img className="w-50 d-block mx-auto" src={require("../images/paper-icon.svg")} alt="" />
        ...
        <div className="col-md-4 col-sm-6">
          <img className="w-50 d-block mx-auto" src={require("../images/mag-icon.svg")} alt="" />
        ...
        <div className="col-md-4 col-sm-6">
          <img className="w-50 d-block mx-auto" src={require("../images/card-icon.svg")} alt="" />
        ...
        <div className="col-md-4 col-sm-6">
          <img className="w-50 d-block mx-auto" src={require("../images/piggy-icon.svg")} alt="" />
        ...
        <div className="col-md-4 col-sm-6">
          <img className="w-50 d-block mx-auto" src={require("../images/people-icon.svg")} alt="" />
